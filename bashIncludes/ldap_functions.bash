...
function ldapsearchexists ()
{
  ...
  if [ $RC -ne 0 ]; then
    msg_error "ldapsearch not found"
  return 1
  fi
#else
#  msg_error "Not Solaris, exiting ..."
#  return 1
#fi
}
...
{
[ "$#" -eq 0 ] && msg_help "$FUNCNAME <userid>" && return 1
...
{
ldapsearchexists || return 1
[ $# -eq 0 ] && msg_help "$FUNCNAME <uid>" && return 1
...
{
ldapsearchexists || return 1
[ $# -eq 0 ] && msg_help "$FUNCNAME <opdtxxx>" && return 1
